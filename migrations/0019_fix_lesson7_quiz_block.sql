-- Fix Lesson 7 (Mastering ChatGPT) quiz content block
-- The 2nd content block (type=quiz) had an empty questions array.
-- This copies the 5 questions from the lesson-level quiz field into that block.

UPDATE lessons
SET content_blocks = replace(
  content_blocks,
  '"content":"{\"title\":\"Quiz\",\"questions\":[],\"passThreshold\":70}"',
