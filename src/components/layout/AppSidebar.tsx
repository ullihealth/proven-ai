...
export const AppSidebar = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-[#0E1014] border-r border-[rgba(255,255,255,.05)] overflow-hidden flex flex-col">
      {/* Logo */}
      <div className="flex items-center justify-center px-4 pt-1 pb-2">
        <img src="/PROVEN%20AI%20MAIN6.png" alt="Proven AI" className="h-[140px] w-auto max-w-[240px] object-contain" />
      </div>
