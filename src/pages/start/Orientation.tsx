...
const Orientation = () => {
  return (
    <AppLayout>
      <ContentPageTemplate
        title="Orientation"
        description="Get your bearings and understand what Proven AI is all about. This is your starting point for a clear, structured journey into AI."
        whoFor="New members who want to understand the big picture before diving in"
        whyMatters="A clear orientation prevents overwhelm and helps you navigate with confidence"
        lastUpdated="January 28, 2026"
      >
        <section className="space-y-6">
          <h2>What is Proven AI?</h2>
          <p>
          ...
          <p>
            ...
            Every piece of content is designed to help you feel oriented, confident, and supported.
          </p>
          ...
          <ul className="space-y-3 mt-4">
            {[
              { title: "Start Here", desc: "Foundational content including this orientation, how Proven AI works, and membership details." },
          ...
          <p>
            After reading this orientation, we recommend:
          </p>
