  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 min-h-0">
        ...
        {!sidebarCollapsed && (
          <aside
            className="flex-shrink-0 flex flex-col border-r border-[#30363d] bg-[#161b22]"
        ...
        >
          ...
          <div className="w-px h-full bg-[#30363d] group-hover:bg-[#00bcd4]/40 transition-colors" />
          {/* Collapse button */}
          <button
            onClick={toggleSidebar}
            className="absolute z-10 flex items-center justify-center w-5 h-5 rounded-full bg-[#242b35] border border-[#30363d] text-[#a0aab8] hover:text-[#00bcd4] hover:border-[#00bcd4] transition-colors shadow"
              ...
              <div className="flex-1 min-h-0 px-8 py-4 overflow-y-auto">
                {isToday ? (
                  <textarea
                    ...
                    className="w-full h-full min-h-[500px] bg-transparent text-[#e0e7ef] placeholder-[#a0aab8] text-sm leading-relaxed resize-none outline-none"
