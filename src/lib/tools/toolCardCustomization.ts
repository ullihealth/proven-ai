...
export const DEFAULT_CORE_TOOLS_SETTINGS: ToolCardSettings = {
  ...
  cardBackground: "222 22% 14%",
  cardBorder: "222 30% 20%",
  cardHoverBorder: "217 91% 60% / 0.3",
  cardShadow: 15,
  cardShadowDirection: 180,
  
  subCardPositiveBackground: "222 30% 17%",
  subCardPositiveBorder: "222 25% 24%",
  subCardNegativeBackground: "222 28% 15%",
  subCardNegativeBorder: "222 25% 22%",
  subCardShadow: 0,
