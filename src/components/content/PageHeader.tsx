      ...
      <div className="flex items-start gap-3">
        <div className="flex-1">
          <div className="flex items-center gap-3">
            ...
            {badge && <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium text-secondary-foreground border border-secondary/30 bg-muted-foreground">
                {badge}
              </span>}
          </div>
